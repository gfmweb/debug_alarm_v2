...
class Test extends BaseController
{
    ...
    public function index()
    {
	    ...
	    $result = $curl->request('POST', $options['baseURI'],
		    ['form_params' =>
			    [
			        'log' => json_encode(['title'=>'title2','type'=>'single', 'block_id'=>12, 'part'=>'body','data'=>['some data'],'recipients'=>['admin'],'alert_mode'=>'silent'],256),
		        ]
		    ]);
	...
	public function telega()
	{
		...
		$row = '{ "valid": true, "errors": "", "log_record": { "title": "title758", "type": "single", "block_id": 12, "part": "body", "recipients": [ { "user_id": "1", "user_telegram_id": "822173207", "user_name": "admin", "user_login": "admin" } ], "alert_mode": "silent", "log_structured_data": [ "some data" ], "project_name": "СМС-Конвеер", "project_id": "1", "status": "normal" } }';
